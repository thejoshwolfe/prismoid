...
static void test_physics() {
    List<Entity> actual_entities;
    // make this variable have the same type signature as the one used in the real code
    // to better facilitate copypasting
    List<Entity> * entities = &actual_entities;
